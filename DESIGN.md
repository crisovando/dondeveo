...
- **Focus:** a 4px ring of Rojo Dondeveo Hover (`0 0 0 4px`) around a transparent 2px buffer — the input's focus speaks in the action accent, not in blue, because search _is_ the action.
